...
def zip_model_and_loss_and_class_names(MODEL_PATH):
    print(f"[INFO] Zipping model in {MODEL_PATH}")
...
ALL_CHECKS_GOOD =  PATHS_GOOD and COUNT_EQUAL and ALL_FILES_PAIRED and VAL_PATHS_GOOD and VAL_COUNT_EQUAL and VAL_ALL_FILES_PAIRED
if ALL_CHECKS_GOOD:
